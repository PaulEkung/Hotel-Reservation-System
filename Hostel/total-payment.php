...
<!-- <br> -->
<?php
echo "&nbsp;&nbsp;<a href='total-users.php' class='bi bi-arrow-left-circle offset-0 text-secondary fs-1'></a> ";
require "db_connect.php";


    $sql = "SELECT stu.*, fe.*, ma.* FROM `students`stu, `payment-2`fe, `payment`ma WHERE stu.email = fe.email OR stu.email = ma.email";
