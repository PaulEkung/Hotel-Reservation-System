...
<section id="instructor" class="p-3 bg-secondary">
    ...
    <div class="container">
        <h2 class="text-center text-white">
            All Avalaible Rooms For Female Hostel
        </h2>
        <a href="rooms-2.php" class="position-absolute text-decoration-none btn btn-warning">View Rooms For Male Hostel</a>
        <p class="lead text-center text-white mb-4">
            ...
            <a href="payment_page.php" class="position-absolute text-decoration-none btn btn-primary offset-1">Make Payments</a>
        ...
        <div class="row g-3">
            ...
            <?php 
            $result;
            $sql = $connect->query("SELECT room_number FROM `payment-2`;");
            if($sql)
            {
