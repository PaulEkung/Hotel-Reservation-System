...
if(isset($_POST["submit"]))
{
    ...
    $sql = "SELECT stu.*, fe.* FROM `students`stu, `payment-2`fe WHERE stu.email = fe.email AND stu.unique_id ='$id'";
...
print("<a href='delete-guests-info.php?deleteEmail=$email' class='bi bi-check-circle fs-2 text-success offset-4'></a>");
